...
int* parserCMD::parserV2(char buff[]) {
	...
	else if (arrayWord[0] == "arduino" && arrayWord[1] == "screen" && arrayWord[2] == "on") {
	...
	else if (arrayWord[0] == "arduino" && arrayWord[1] == "screen" && arrayWord[2] == "off") {
	...
	else if (arrayWord[0] == "game" && arrayWord[1] == "move") {


	try
	{

		arrayData[0] = GAME_MOVE; //CMD
		arrayData[2] = stoi(arrayWord[2]);
	...
	else if (arrayWord[0] == "game" && arrayWord[1] == "restart") {


	try
	{

		arrayData[0] = GAME_RESTART; //CMD
